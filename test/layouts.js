...
describe('layouts.js', function() {
	describe('List', function() {
		...
		it('lines up its children', function() {
			assert.equal(list.children[0].x, 5);
			assert.equal(list.children[1].x, 18);
			assert.equal(list.children[2].x, 33);
		});
		...
		it('adds padding between children', function() {
			...
			assert.equal(list.children[0].x, 5);
			assert.equal(list.children[1].x, 22);
			assert.equal(list.children[2].x, 41);
